...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2(){  
            // Method syntax
            IEnumerable<Emp> methodSyntax = Emps
        ...
        public static IEnumerable<Emp> Task4()
        {
            IEnumerable<Emp> result = 
                    from e in Emps
                    where e.Salary == (from eEmp in Emps select eEmp.Salary).Max()
                    select e;
            return result;
        }
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = 
                    from e in Emps
                    join dept in Depts on e.Deptno equals dept.Deptno
        ...
        {
            Emp result = (from e in Emps
                    where e.Job.Equals("Frontend programmer")
